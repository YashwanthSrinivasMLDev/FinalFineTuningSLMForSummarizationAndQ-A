...
def start_main_app() :
    ...
    try :
        ...
        train_dataloader_summary_training_data = load_training_data_for_multi_task_fine_tuning(training_data_summaries,training_data_qa, model_trained_CT_on_insurance_datasets_tiny_llama)
